...
class AntennaCalibration():
    ...
    def _freq_num_to_freq_name(system: str, freq_num: str) -> Union[None, str]:
        ...
        freq_num_to_freq_name = {
            "C": {"1": "B1C", "2": "B1", "5": "B2a", "6": "B3", "7": "B2b", "8": "B2"},
    ...
    def _gnss_to_antex_freq(system: str, frequency: str) -> Union[None, str]:
        ...
        gnss_to_antex_freq = {
            "C": {"B1": "C02", "B1A": "C01", "B1C": "C01", "B2": "C07", "B2a": "C05", "B2b": "C07", "B3": "C06", "B3A": "C06"},
            "E": {"E1": "E01", "E5": "E08", "E5a": "E05", "E5b": "E07", "E6": "E06"},
            "G": {"L1": "G01", "L2": "G02", "L2C": "G02", "L5": "G05"},
            "I": {"L5": "I05", "S": "I09"},
            "J": {"L1": "J01", "L2": "J02", "L5": "J05", "L6": "J06"},
            "R": {"G1": "R01", "G1a": "R04", "G2": "R02", "G2a": "R06", "G3": "R03"},
            "S": {"L1": "S01", "L5": "S05"},
        }
